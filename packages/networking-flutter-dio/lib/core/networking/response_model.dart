...
class ResponseHeadersModel {
  const ResponseHeadersModel({required this.message});

  factory ResponseHeadersModel.fromJson(JSON json) {
    return ResponseHeadersModel(message: json['message'] as String?);
  }
...
class ResponseModel<T> {
  ...
  factory ResponseModel.fromJsonList(List<JSON> json) {
    return ResponseModel(body: json as T, headers: null);
  }
